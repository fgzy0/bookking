        ...
        <div class="px-10">
            ...
            if($_SESSION["user"]["role"] == "Admin"){
                ...
                <div class="mb-6 border-t-4 dark:border-white border-black rounded-sm">
                    <h1 class="text-3xl mb-2 hover:text-orange-700 transition-all"><a href="/dashboard">Панель администратора</a></h1>
            ...
            ?>
            <div class="mb-6 border-t-4 dark:border-white border-black rounded-sm">
                <h1 class="text-3xl mb-2 hover:text-orange-700 transition-all"><a href="/personal-data">Аватар</a></h1>
                <img class="w-[200px] h-[200px] rounded-md" src="/png_files/avatars/<?=$_SESSION["user"]["avatar"]?>">
            </div>
            <div class="mb-6 border-t-4 dark:border-white border-black rounded-sm">
                <h1 class="text-3xl mb-2 hover:text-orange-700 transition-all"><a href="/personal-data">Личные данные</a></h1>
            ...
            <div class="mb-6 border-t-4 dark:border-white border-black rounded-sm">
                <h1 class="text-3xl mb-2 hover:text-orange-700 transition-all"><a href="#">Активные заказы</a></h1>
                <p class="text-xl mb-1">У вас пока нет активных заказов</p>
            </div>
            <div class="mb-6 border-t-4 dark:border-white border-black rounded-sm">
                <h1 class="text-3xl mb-2 hover:text-orange-700 transition-all"><a href="#">Закладки</a></h1>
